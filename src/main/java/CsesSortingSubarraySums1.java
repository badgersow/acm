...
public class CsesSortingSubarraySums1 {
    ...
    public void solve() throws Exception {
        ...
        final int requiredSum = in.nextInt();
        final HashMap<Long, Integer> countBySum = new HashMap<>();

        long sum = 0L;
        long result = 0L;
        countBySum.put(sum, 1);
        ...
        for (int i = 0; i < n; i++) {
            ...
            result += countBySum.getOrDefault(sum - requiredSum, 0);
            countBySum.merge(sum, 1, Integer::sum);
        }
